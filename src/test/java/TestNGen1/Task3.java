...
public class Task3 {
    ...
    // Проверить что слово “смесь” присутствует в сообщении о результатах поиска. После ввести в строку
    // поиска слово “спесь” и совершить поиск. Проверить что слово “спесь” присутствует в сообщении о результатах
    // поиска. После ввести в строку поиска слово “ересь” и совершить поиск. Проверить что слово “ересь”
    // присутствует в сообщении о результатах поиска.
    ...
    public void Test3Result(){
        Dz7 exempClassa = new Dz7(driver);
        Actions actions = new Actions(driver);
        WebElement search= driver.findElement(By.xpath("//input[@class='search__input']"));
        exempClassa.waitVisabilityOfElemetLocated(By.xpath("//input[@class='search__input']"));
        search.sendKeys("смесь");
        search.submit();
        WebElement resSmes= driver.findElement(By.xpath("//h1[@id='j-catalog-header']"));
        exempClassa.waitVisabilityOfElemetLocated(By.xpath("//h1[@id='j-catalog-header']"));
        ...
        exempClassa.waitPresenceOfElementReturn(By.xpath("//h1[@id='j-catalog-header']"));
